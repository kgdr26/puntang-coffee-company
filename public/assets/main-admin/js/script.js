                ...
                '<ul>' +
                    '<li class="theme-option">' +
                        ...
                        '<div class="form-radio" id="menu-effect">'+
                            '<div class="radio radio-inverse radio-inline" data-bs-toggle="tooltip" title="simple icon">'+
                                '<label>'+
                                ...
                                '</label>'+
                            '</div>'+
                            '<div class="radio  radio-primary radio-inline" data-bs-toggle="tooltip" title="color icon">'+
                                '<label>'+
