...
$(document).ready(function() {
    ...
    var newuserEl = document.getElementById("newuserchart");
    if (newuserEl) {
        window.myDoughnut = new Chart(newuserEl.getContext("2d"), {
            type: 'doughnut',
            data: {
                datasets: [{
                    data: [10,34,5],
    ...
    // sale order start
    initChart('sale-chart1', 'line', salechart('#b71c1c', [25, 30, 15, 20, 25, 30, 15, 25, 35, 30, 20, 10, 12, 1], 'transparent'), salebuildoption());
    initChart('sale-chart2', 'line', salechart('#00692c', [30, 15, 25, 35, 30, 20, 25, 30, 15, 20, 25,10, 12, 1], 'transparent'), salebuildoption());
    initChart('sale-chart3', 'line', salechart('#096567', [15, 20, 25,10, 30, 15, 25, 35, 30, 20, 25, 30, 12, 1], 'transparent'), salebuildoption());
