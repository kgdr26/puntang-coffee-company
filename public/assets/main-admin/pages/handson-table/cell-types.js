...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function getCarData() {
    return [
      {car: "Mercedes A 160", year: 2025, price_usd: 7000, price_eur: 7000},
      {car: "Citroen C4 Coupe", year: 2026, price_usd: 8330, price_eur: 8330},
      {car: "Audi A4 Avant", year: 2027, price_usd: 33900, price_eur: 33900},
      {car: "Opel Astra", year: 2028, price_usd: 5000, price_eur: 5000},
      {car: "BMW 320i Coupe", year: 2029, price_usd: 30500, price_eur: 30500}
    ];
  }
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function getCarData() {
    return [
      ["Mercedes", "A 160", "01/14/2026", 6999.9999],
      ["Citroen", "C4 Coupe", "12/01/2027", 8330],
      ["Audi", "A4 Avant", "11/19/2028", 33900],
      ["Opel", "Astra", "02/02/2029", 7000],
      ["BMW", "320i Coupe", "07/24/2025", 30500]
    ];
  }
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function getCarData() {
    return [
      {car: "Mercedes A 160", year: 2026, available: true, comesInBlack: 'yes'},
      {car: "Citroen C4 Coupe", year: 2027, available: false, comesInBlack: 'yes'},
      {car: "Audi A4 Avant", year: 2028, available: true, comesInBlack: 'no'},
      {car: "Opel Astra", year: 2029, available: false, comesInBlack: 'yes'},
      {car: "BMW 320i Coupe", year: 2025, available: false, comesInBlack: 'no'}
    ];
  }
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function getCarData() {
    return [
      ["Nissan", 2026, "black", "black"],
      ["Nissan", 2027, "blue", "blue"],
      ["Chrysler", 2028, "yellow", "black"],
      ["Volvo", 2029, "white", "gray"]
    ];
  }
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function getCarData() {
    return [
      ["Nissan", 2027, "black", "black"],
      ["Nissan", 2028, "blue", "blue"],
      ["Chrysler", 2029, "yellow", "black"],
      ["Volvo", 2025, "white", "gray"]
    ];
  }
