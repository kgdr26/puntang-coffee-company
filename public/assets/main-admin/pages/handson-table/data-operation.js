document.addEventListener("DOMContentLoaded", function() {
    ...
    var data=[["Nissan", 2026, "black", "black"], ["Nissan", 2027, "blue", "blue"], ["Chrysler", 2028, "yellow", "black"], ["Volvo", 2029, "yellow", "gray"]], example=document.getElementById("searching"), searchFiled=document.getElementById("search_field");
    hot=new Handsontable(example, {
        data: data, colHeaders: !0, search: !0
    }
    ), searchFiled.addEventListener("keyup", function(event) {
