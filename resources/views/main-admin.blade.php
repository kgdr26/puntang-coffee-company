...
<body>
    ...
    <!-- Chart js -->
    <script src="{{ asset('assets/main-admin/plugins/chart.js/dist/chart.umd.js') }}"></script>
    <!-- amchart js -->
    <script src="{{ asset('assets/main-admin/pages/widget/amchart/amcharts.js') }}"></script>
    <script src="{{ asset('assets/main-admin/pages/widget/amchart/serial.js') }}"></script>
    <script src="{{ asset('assets/main-admin/pages/widget/amchart/light.js') }}"></script>
    ...
    <script src="{{ asset('assets/main-admin/js/SmoothScroll.js') }}"></script>
    <script src="{{ asset('assets/main-admin/pages/dashboard/custom-dashboard.js') }}"></script>
</body>
</html>