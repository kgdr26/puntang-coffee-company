...
<section class="section section-default border-0 my-2 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="750" style="background: var(--bg-warm);padding:0rem;">
            ...
            <div class="col-md-6 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1000">
                <div class="owl-carousel owl-theme nav-inside mb-0" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 6000, 'loop': true}">
                    ...
                    @foreach($loop_img as $val)
                        <div>
                            <img alt="" class="img-fluid" src="{{ asset('assets/img/about/'.$val) }}" style="height: 20rem">
                        </div>
                    @endforeach
                        ...
                        <div class="portfolio-item">
                            <span class="thumb-info thumb-info-lighten thumb-info-no-borders thumb-info-bottom-info thumb-info-centered-icons border-radius-0">
                                <span class="thumb-info-wrapper border-radius-0">
                                    <img src="{{ asset('assets/img/about/'.$vg) }}" class="img-fluid border-radius-0" alt="" style="width: 100%; height: 15rem;">
                                </span>
                            </span>
                        </div>
                    @endforeach
