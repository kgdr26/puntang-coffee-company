    ...
    <div class="page-body">
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="../assets/images/widget/GERMANY.jpg"
                                    ...
                                    <tr>
                                        <td><img src="../assets/images/widget/USA.jpg"
                                                alt="" class="img-fluid img-30"></td>
                                        <td>USA</td>
                                        <td>2,650</td>
                                    ...
                                    <tr>
                                        <td><img src="../assets/images/widget/AUSTRALIA.jpg"
                                                alt="" class="img-fluid img-30"></td>
                                        <td>Australia</td>
                                        <td>956</td>
                                    ...
                                    <tr>
                                        <td><img src="../assets/images/widget/UK.jpg"
                                                alt="" class="img-fluid img-30"></td>
                                    ...
                                    <tr>
                                        <td><img src="../assets/images/widget/BRAZIL.jpg"
                                                alt="" class="img-fluid img-30"></td>
                                        <td>Brazil</td>
                                        <td>560</td>
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <i class="fa-brands fa-x-twitter text-c-green f-40"></i>
                ...
                <div class="card o-hidden">
                    <div class="card-body bg-c-pink text-white">
                        <h6>Sales Per Day <span class="f-right"><i
                                    class="feather icon-activity m-r-15"></i>3%</span>
                        </h6>
                ...
                <div class="card o-hidden">
                    <div class="card-body bg-c-green text-white">
                        <h6>Visits<span class="f-right"><i
                                    class="feather icon-activity m-r-15"></i>9%</span>
                        </h6>
            ...
            <div class="col-xl-4 col-md-12">
                <div class="card o-hidden">
                    <div class="card-body bg-c-blue text-white">
                        <h6>Orders<span class="f-right"><i
                                    class="feather icon-activity m-r-15"></i>12%</span>
                        </h6>
            ...
            <div class="col-xl-4 col-md-12">
                <div class="card quater-card">
                    <div class="card-body">
                        ...
                        <div class="progress">
                            <div class="progress-bar bg-simple-c-pink"
                                style="width: 80%"></div>
                        </div>
                        ...
                        <div class="progress">
                            <div class="progress-bar bg-simple-c-yellow"
                                style="width: 50%"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-8 col-md-12">
                <div class="card social-network">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <i class="fa-brands fa-youtube d-block f-30 p-b-20" style="color: #FF0000;"></i>
                                <div class="row">
                                    <div class="col-5">
                            ...
                            <div class="col-sm-6">
                                <i class="fa-brands fa-facebook d-block f-30 p-b-20" style="color: #3B5998;"></i>
                                <div class="row">
                                    <div class="col-5">
                        ...
                        <div class="row">
                            <div class="col-sm-6 m-t-0">
                                <i class="fa-brands fa-x-twitter d-block f-30 p-b-10 p-t-10" style="color: #000000;"></i>
                                <div class="row">
                                    <div class="col-5">
                                        <p class="text-muted m-b-5">Posts :</p>
                                    </div>
                                    <div class="col-7">
                            ...
                            <div class="col-sm-6 m-t-0">
                                <i class="fa-brands fa-instagram d-block f-30 p-b-10 p-t-10" style="color: #E1306C;"></i>
                                <div class="row">
                                    <div class="col-5">
                                        <p class="text-muted m-b-5">Followers :</p>
                                    </div>
                                    <div class="col-7">
                                        <p class="m-b-5 f-w-400">84,295</p>
                                    </div>
                                </div>
                            </div>
                        </div>
